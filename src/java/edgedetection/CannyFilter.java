...
public class CannyFilter {
    ...
    public CannyFilter(float lowThreshold, float highThreshold) {
    ...
    public BufferedImage getBufferedImage(Image img){
        CannyFilter detector = new CannyFilter(lowThreshold,highThreshold);
        detector.setSourceImage(img.getImage());
        detector.process();
